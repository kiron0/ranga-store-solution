...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${product.image}></img>
      ...
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now button">Add to cart</button>
      <button id="details-btn" class="button">Details</button></div>
      `;
